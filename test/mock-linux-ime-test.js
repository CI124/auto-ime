...
test('bundle 包含自适应轮询', () => assert.ok(bundleSrc.includes('adaptivePolling') || bundleSrc.includes('startAdaptivePolling')));
test('bundle 包含 runBashAsync', () => assert.ok(bundleSrc.includes('runBashAsync')));
test('bundle 包含 queryModeAsync', () => assert.ok(bundleSrc.includes('queryModeAsync')));
test('bundle 包含 activeInterval 配置', () => assert.ok(bundleSrc.includes('activeInterval')));
test('bundle 包含 idleInterval 配置', () => assert.ok(bundleSrc.includes('idleInterval')));
